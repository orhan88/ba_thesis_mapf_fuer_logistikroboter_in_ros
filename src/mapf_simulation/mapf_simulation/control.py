...
#from mapf_simulation.parser import AspParser
from mapf_simulation.modelView import *
#from mapf_simulation.network import *
from mapf_simulation.gui import *
...
class VisualizerWindow(QMainWindow):
    '''
    This class represents the GUI-application    
    '''
    ...
    def init_gui(self):
        ...
        -   Left:   buttons and other GUI-elements for the interaction with the user
        -   Center: area for the visualization of the simulation
        -   Right:  table for more detailed information about the robots
        '''
        ...
        #LEFT
        self._leftside_widget = LeftSideWidget()
        self._leftside_widget.set_model_view(self._model_view)
        self._leftside_widget.set_model(self._model)
        
        #RIGHT
        self._rightside_widget = RightSideWidget()
        self._rightside_widget.set_model_view(self._model_view)
        self._rightside_widget.set_model(self._model)
        
        #ADD ELEMENTS
        self._splitter.addWidget(self._leftside_widget)
        self._splitter.addWidget(self._model_view)
        self._splitter.addWidget(self._rightside_widget)

        #SET HORIZONTAL SIZE OF ELEMENTS
        self._splitter.setSizes([120, 500, 120])
        ...
        self.setWindowTitle('MAPF Simulator') 
    ...
    def init_menu(self):
        '''
        This function initializes the menus in the main window. 
        This function is not necessary and is used for demonstration purposes only. Following menus will be created:
        -   Menu: File->Exit  
        -   Menu: Tools 
        '''
        self.statusBar()
        ...
        #just as Example: Menu: Tools -> Settings
    ...
    def closeEvent(self, event):
        '''
        This function is beeing called when the window closes!
        '''
...
class VizControl(object): 
    def run(self):
        '''
        This function initializes ROS2 and runs the GUI-application
        '''
        #init ROS2
        rclpy.init()
...
'''
#show it at begin
#self.switch_widget(self._instance_file_browser)
