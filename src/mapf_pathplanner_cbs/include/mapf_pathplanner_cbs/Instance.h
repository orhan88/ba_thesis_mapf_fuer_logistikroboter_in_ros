...
public:
	...
	Instance(const mapf_interfaces::msg::MAPFInstance::SharedPtr instance_msg);

	void loadMapFromMsg(const mapf_interfaces::msg::MAPFInstance::SharedPtr instance_msg);
	void loadAgentsFromMsg(const mapf_interfaces::msg::MAPFInstance::SharedPtr instance_msg);
